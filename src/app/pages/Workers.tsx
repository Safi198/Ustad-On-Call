              ...
              {filteredWorkers.map((worker) => (
                ...
                >
                  ...
                  <td className="px-4">
                    <div className="flex items-center gap-1">
                      <button
                        onClick={() => navigate(`/dashboard/workers/profile`)}
                      ...
                      <div className="relative">
                        ...
                        {showContextMenu === worker.id && (
                          <div className="absolute right-0 top-full mt-1 w-48 bg-[#252525] border border-[#333333] rounded-lg shadow-dropdown z-50 py-1 animate-in slide-in-from-top-2 duration-150">
                            <button onClick={() => { navigate(`/dashboard/workers/profile`); setShowContextMenu(null); }} className="w-full flex items-center gap-3 px-4 py-2 text-sm text-[#F5F5F5] hover:bg-[#1E1E1E] transition-colors">
